...
class metadatavalidationService:
  def createService(self, config):
    ...
    scale_out_alarm = cloudwatch.Alarm(self,
        ...
        alarm_name=f"{config['main']['resource_prefix']}-{config['main']['tier']}-metadata-scaleout-alarm",
        metric=sqs_metric,
        threshold=1,
    ...
    scale_out_action = scalable_target.scale_on_metric(
        f"{config['main']['resource_prefix']}-{config['main']['tier']}-metadata-scale-out",
        metric=sqs_metric,
        scaling_steps=[
    ...
    scale_in_alarm = cloudwatch.Alarm(self,
        ...
        alarm_name=f"{config['main']['resource_prefix']}-{config['main']['tier']}-metadata-scalein-alarm",
        metric=sqs_metric,
        threshold=0,
    ...
    scale_in_action = scalable_target.scale_on_metric(
        f"{config['main']['resource_prefix']}-{config['main']['tier']}-metadata-scale-in",
        metric=sqs_metric,
        scaling_steps=[
